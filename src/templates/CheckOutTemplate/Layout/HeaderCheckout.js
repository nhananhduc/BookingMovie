...
export default function HeaderCheckout(props) {
    ...
    return (
        <header className="border-b px-2 py-4 lg:p-7 bg-neutral-900 text-white w-full">
            <div className="container flex justify-between h-16 mx-auto p-0">
                ...
                <div className="items-center justify-center flex-shrink-0 hidden md:flex">
                    {/* <Select defaultValue="en" style={{ width: 100, marginLeft: '10px' }} onChange={handleChange}>
